...
namespace CodeSnippets.Windows.Tests.GemBox.Document
{
    public class GemBoxDocumentTests
    {
        public GemBoxDocumentTests()
        {
            ComponentInfo.SetLicense("FREE-LIMITED-KEY");
            ComponentInfo.FreeLimitReached +=
                (sender, args) => args.FreeLimitReachedAction = FreeLimitReachedAction.ContinueAsTrial;
        }
        ...
        public void CanUpdateToc()
        {
            ...
            document.Save("DocumentWithUpdatedToc.docx");
            document.Save("DocumentWithUpdatedToc.pdf");
        }
    }
}
